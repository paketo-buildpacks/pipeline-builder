	...
	context("draft a release", func() {
		...
		context("generates body", func() {
			...
			it("generates composite", func() {
				...
				Expect(body).To(ContainSubstring("BP 1 | `bp1` | [3.1.0](https://github.com/bp1/releases/3.1.0)"))
				Expect(body).To(ContainSubstring("BP 2 | `bp2` | [9.3.1](https://github.com/bp2/releases/9.3.1)"))
				Expect(body).To(ContainSubstring("BP 3 | `bp3` | [1.10.0](https://github.com/bp3/releases/1.10.0)"))
				Expect(body).To(ContainSubstring("BP 4 | `bp4` | [6.5.0](https://github.com/bp4/releases/6.5.0)"))
